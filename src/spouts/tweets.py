...
################################################################################
twitter_credentials = {
    "consumer_key"        :  "kx1K2a3u5QwqMTemXI3jhOWuq",
    "consumer_secret"     :  "bERaPVZkronQIxIDWL3g7GcklZ3uVs4vm0VguWJrop5Sx3toZG",
    "access_token"        :  "421342125-4Jyvk46W4SZBcLR2E6cX43o0fqyV3l1ClRI1HSJm",
    "access_token_secret" :  "N3QYVuUgJYV61hVaB6aAbqYlcLA7HCxl2oKaAKSkri41P",
}
...
class TweetStreamListener(tweepy.StreamListener):
    ...
    def on_error(self, status_code):
        self.listener.log('Error: %s' % status_code)
...
#            listener.queue().put(self.dataJsonText)
#
#            return True
#        except Exception, e:
